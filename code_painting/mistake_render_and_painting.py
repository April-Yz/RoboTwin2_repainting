...
def demo_usage():
    ...
    # 保存原始相机旋转矩阵，用于后续手腕朝向修正
    # camera_rotation_original = camera_rotation.copy()
    ...
    # 方法1: 使用相机旋转矩阵的逆来修正手腕朝向
    # 这样可以保持手腕相对于相机的朝向关系不变
    camera_rotation_inv = camera_rotation_original.T  # 正交矩阵的逆等于转置
    
    # 将手腕朝向从世界坐标系转换到相机坐标系，再转换回世界坐标系
    # 这样可以保持相对朝向关系
    left_rot_world_corrected = camera_rotation_inv @ left_rot_world @ camera_rotation_original
    right_rot_world_corrected = camera_rotation_inv @ right_rot_world @ camera_rotation_original
    ...
    # left_rot_world  = R_y180_left @ left_rot_world
    # right_rot_world = R_y180_right @ right_rot_world
    left_rot_world  = R_y180_left @ left_rot_world_corrected
    right_rot_world = R_y180_right @ right_rot_world_corrected  
    # # 设置手臂朝前的旋转矩阵
